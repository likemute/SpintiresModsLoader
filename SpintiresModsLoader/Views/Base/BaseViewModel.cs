 ...
 *
 * BaseViewModel.cs is part of SpintiresModsLoader.
 * 
 ...
 * create date: 2017-6-15, 14:28
 */
using System.ComponentModel;
using System.Windows;

namespace SpintiresModsLoader.Views.Base
{
    public abstract class BaseViewModel : NotifyClass
    {
        protected bool IsInDesignMode => DesignerProperties.GetIsInDesignMode(new DependencyObject());

        protected App GetApp()
        {
            return ((Sys)Application.Current).App;
        }

        protected Sys Sys => (Sys)Application.Current;
    }
}